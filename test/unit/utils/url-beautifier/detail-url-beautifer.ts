...
describe('detail URL beautifier', () => {
  ...
  describe('detail URL parser', () => {
    ...
    it('should decode special characters in navigation name and values', () => {
      ...
      expect(parser.parse(parseUri('/satin-shiny-party-dress/h%26m/brand/blue/colour/red/colour/293014'))).to.eql(expectedDetail);
    });
    ...
    describe('error states', () => {
      ...
      it('should throw an error if the path without reference keys has an odd number of parts', () => {
        ...
        expect(() => parser.parse(parseUri('/dress/blue/colour/red/293014'))).to.throw('path has an odd number of parts');
      });
