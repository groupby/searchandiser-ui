...
[Integrate with an existing website](docs/integration.md);
...
<html>
  <head>
    <script src="http://cdn.groupbycloud.com/dist/searchandiser-ui-0.0.28.js"></script>
  </head>
  <body>
    ...
  </body>
  ...
  <body>
    ...
    <script>
      ...
      searchandiser.attach('paging', '.paging', {
        ...
        // showTerminals: false
        //
        // change terminal labels to first and last page number from 'First' and 'Last'
        // numeric: false
      });
