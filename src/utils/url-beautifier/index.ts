...
export { BeautifierConfig, Detail, UrlBeautifier, QueryUrlGenerator, QueryUrlParser, NavigationUrlGenerator, NavigationUrlParser, DetailUrlGenerator, DetailUrlParser };
